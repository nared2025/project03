...
<head>
    ...
    <title>แอดมินจัดการสินค้า - Pawland</title>
...
<body>
    <header>
        <nav>
            <div class="nav-wrapper">
                <div class="logo">🐾 Pawland Admin</div>
                <ul class="nav-links">
                    <li><a href="index.html">🏠 หน้าแรก</a></li>
                    <li><a href="#" id="adminLogoutLink">🚪 ออกจากระบบแอดมิน</a></li>
                </ul>
            </div>
        </nav>
    </header>
    ...
    <footer>
        <p>&copy; 2024 Pawland. Admin panel.</p>
    </footer>
...
<?php /**PATH C:\xampp\htdocs\pawland\resources\views/admin/adminpanel.blade.php ENDPATH**/ ?>